...
import CreateNewListModal from "../../VocabListComponents/CreateNewListModal";
import DeckListPage from "../../../pages/VocabListPage/DeckListPage";
import PrivateList from "../../../pages/VocabListPage/DeckListPage/PrivateList";
import "./style.css";
  ...
  return (
    <>
      <div className="container mt-5 flex justify-content-center">
        ...
        {menu === "private" && (
          <>
            <PrivateList type="private" changeView={goToList} category="private" />
          </>
        )}
      </div>
    </>
