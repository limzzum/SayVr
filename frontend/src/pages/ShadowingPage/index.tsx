      ...
      <div className="shadowingpage-container">
        ...
        <div className="row justify-content-center align-items-center mt-3">
          <button className="youtubecard col-2" style={{ border: "none" }}>
            <img src={BBC} alt="BBC Logo" style={{ width: "90%", height: "100%" }} />
          </button>
          <button className="youtubecard col-2" style={{ border: "none" }}>
            <img src={CNN} alt="CNN Logo" style={{ width: "90%", height: "100%" }} />
          </button>
          <button className="youtubecard col-2" style={{ border: "none" }}>
            <img src={TeamCOCO} alt="TeamCOCO Logo" style={{ width: "90%", height: "100%" }} />
          </button>
          <button className="youtubecard col-2" style={{ border: "none" }}>
            <img src={Ted} alt="Ted Logo" style={{ width: "90%", height: "100%" }} />
          </button>
        </div>
      </div>
    </div>
